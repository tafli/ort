...
class DownloadResultsFromPostgresCommand : CliktCommand(
    ...
    override fun run() {
        ...
        openDatabaseConnection().use { connection ->
            ...
            println("Requested the download of ${remoteRowIds.size} of which ${missingRowIds.size} are missing.")
            ...
            missingRowIds.forEachIndexed { i, rowId ->
                ...
                println("[${i + 1} / ${missingRowIds.size}] took ${duration.toString(DurationUnit.SECONDS)}s.")
            }
        }
    }
